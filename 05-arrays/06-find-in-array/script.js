...
(function() {
    ...
    document.getElementById("run").addEventListener("click", function (){
        ...
        let index = people.findIndex(dude => dude.firstname === "Jean");
        // asked help from stefan, figured out that somehow my index of was less optimak than findIndex and
            //= people.indexOf({firstname: "Jean", email: "jdupont@elpais.com", lastname: "Dupont"});
        console.log(index);
        })
